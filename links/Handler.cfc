<cfcomponent extends="org.mangoblog.plugins.BasePlugin">
	...
	<cfset this.events = [
	{ 'name' = 'getFavoriteLinks', 'type' = 'sync', 'priority' = '5' },
	{ 'name' = 'getFavoriteLinksByCategory', 'type' = 'sync', 'priority' = '5' },
	{ 'name' = 'getFavoriteLinkCategories', 'type' = 'sync', 'priority' = '5' },
	{ 'name' = 'getFavoriteLink', 'type' = 'sync', 'priority' = '5' },
	{ 'name' = 'links-secondarynav', 'type' = 'sync', 'priority' = '5' },
	{ 'name' = 'links-showLinksSettings', 'type' = 'sync', 'priority' = '5' },
	{ 'name' = 'links-editLinkSettings', 'type' = 'sync', 'priority' = '5' },
	{ 'name' = 'links-editLinkCategorySettings', 'type' = 'sync', 'priority' = '5' },
	{ 'name' = 'links-deleteLink', 'type' = 'sync', 'priority' = '5' },
	{ 'name' = 'links-deleteLinkCategory', 'type' = 'sync', 'priority' = '5' },
	{ 'name' = 'skinsNav', 'type' = 'sync', 'priority' = '1' }
		] />
	...
	<cffunction name="processEvent" hint="Synchronous event handling" access="public" output="false" returntype="any">
		<cfargument name="event" type="any" required="true" />
			...
			<cfelseif eventName EQ "skinsNav">
				...
				<cfset link.title = "Links" />
				<cfset link.eventName = "links-showLinksSettings" />
				<cfset link.icon = "bi-link-45deg" />
				<cfset arguments.event.addLink(link)>
					
			<!--- admin nav event --->
			<cfelseif eventName EQ "links-secondarynav" AND manager.isCurrentUserLoggedIn()>
				<cfset link = structnew() />
				<cfset link.owner = "Links">
			...
			<cfelseif eventName EQ "links-showLinksSettings" AND manager.isCurrentUserLoggedIn()>
				...
				<cfset data.message.setHierarchy( [{ 'link' = "skins.cfm", 'title' = 'Design' },
						{ 'title' = 'Links' }]) />
				<cfset data.message.setData( getMainPage() ) />
...
<cffunction name="getMainPage">
	<cfset var page = ''/>
	<cfset var categories = getCategories(0) />

	<cfsavecontent variable="page">
		<button class="btn btn-secondary mb-3" type="button"><a href="generic_skin_settings.cfm?event=links-editLinkSettings&owner=Links&selected=Links"><i class="bi bi-plus"></i>New Link</a></button>
		<button class="btn btn-white mb-3" type="button"><a href="generic_skin_settings.cfm?event=links-editLinkCategorySettings&owner=Links&selected=Links"><i class="bi bi-plus"></i>New Category</a></button>
