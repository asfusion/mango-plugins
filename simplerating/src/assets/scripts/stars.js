...
Stars.prototype = {
	...
	initialize: function(options)
	{
		 ...
		 */
		this._starSrc = {
			empty: this.options.imagePath + "star_empty.png",
			full: this.options.imagePath + "star_over.png",
			half: this.options.imagePath + "star_half.png"
		};
		/**
		 * Preload images
		 */
		...
		this._setStarSrc = {
			empty: this.options.imagePath + "star_empty.png",
			full: this.options.imagePath + "star.png",
			half: this.options.imagePath + "star_half.png"
		};
